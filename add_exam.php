            ...
            <div class="container-fluid">
                ...
                <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="name" class="form-control" placeholder="Course Code" id="event" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Create condition to include class size in booking -->
                                        <!-- Include size of NEC in condition -->
                                        <!-- <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label"> Class Size</label>
                                                <div class="col-sm-9">
                                                  <input type="number" name="exam_date" class="form-control" placeholder=" Number of Students" required="">
                                                </div>
                                            </div>
                                        </div> -->
                                        <div class="form-group">
                                            <div class="row">
                                            <label class="col-sm-3 control-label" for="date">Exam Date:</label>
                                                <div class="col-sm-9">
                                                    <input required type="date" name="exam_date" id="date" class="form-control" placeholder=" Date" required="true" title="Choose your desired date" min="<?php echo date('Y-m-d'); ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
